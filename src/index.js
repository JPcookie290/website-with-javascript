...
import { createTags, createHtml, createMoreTags, expandHtml, addIdAndClass, addOneIdAndClass, addDifferentIdAndClass} from './modules/functions';
...
addIdAndClass(htmlTags,'class', '-')
addIdAndClass(htmlListTags, '-', 'list')
